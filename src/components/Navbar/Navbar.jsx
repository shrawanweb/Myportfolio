...
const Navbar = () => {
  ...
  //Check scroll and set navbar background
  useEffect(() => { 
    const handleScroll = () => {
...
const handleMenuItemClick = (sectionId) => {
  ...
  return (
    <nav className={`fixed top-0 w-full z-50 duration-300 px-[7vw] md:px-[7vw] lg:px-[20vw] ${
      ...
      <div className="text-white py-5 flex justify-between items-center">
        ...
        <div className="text-lg font-semibold cursor-pointer">
          ...
          <span className="text-white">Shrawan</span>
          <span className="text-[#8245ec]">/</span>
        ...
        <div className="hidden md:flex space-x-4">
          <a href="https://github.com/shrawanweb"
            target="_blank"
          ...
          <a href="https://www.linkedin.com/in/shrawan-kumar-523223294"
            target="_blank"
            rel="noopener noreferrer"
            className="text-gray-300 hover:text-[#8245ec]"
          >
